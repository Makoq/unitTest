...
ep_service_common.TeacherHomeScreen = 61;

ep_service_common.TeacherHomePage = 62;

ep_service_common.TeacherChannelPage = 63;
    ...
    const data = {
      ...
      learn_plan: {
        ...
        benefits: {
          ...
          before_benefits: arrayMock(2, 4, () => ({
            title: Mock.mock("@ctitle(4, 6)"),
            desc: Mock.mock("@cparagraph(1)"),
          })),
          after_desc: Mock.mock("@cparagraph(1)"),
          after_benefits: arrayMock(2, 4, () => ({
            title: Mock.mock("@ctitle(4, 6)"),
            desc: Mock.mock("@cparagraph(1)"),
          })),
        },
        ...
        finish_time: Mock.mock("@integer(0, 4294967296)"),
  ...
  body: (ctx) => {
    const data = {
      learn_plan: {
        ...
        date_learn_time: Mock.mock("@integer(0, 20)"),
        user: {
          uid: Mock.mock("@integer(0, 4294967296)"),
          uid_str: Mock.mock("@id()"),
          pack_level: enumMock(ep_modelcommon.PackLevel),
      ...
      certificate_pop_up_times: Mock.mock("@integer(0, 1)"),
    };
...
IncentiveApiService.GetLearnTaskList = {
  ...
  body: (ctx) => {
    const data = {
      learn_task_list: arrayMock(2, 12, () => ({
        id: Mock.mock("@id()"),
        name: Mock.mock("@cname()"),
        desc: Mock.mock("@cparagraph(1)"),
        ...
        total_sub_task_count: Mock.mock("@integer(0, 200)"),
        accomplish_sub_task_cunt: Mock.mock("@integer(0, 100)"),
        status: enumMock(ep_incentive.IncentiveStatus),
      })),
      next_cursor: Mock.mock("@integer(0, 4294967296)"),
      has_more: Mock.mock("@boolean()"),
